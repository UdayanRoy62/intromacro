...
This is not some abstract theoretical concept. We can put a number on it. For example, the GDP of the United States in 2019 was \$21,433.226 billion, according to the U.S. Department of Commerce. (For more data, see [this](https://fred.stlouisfed.org/series/GDPA).)

#### Gross Domestic Product per capita

The estimated population of the United States in 2019 was 328,239,523. (For more data, see [this](https://fred.stlouisfed.org/series/B230RC0A052NBEA).)

Therefore, the estimated *per capita (or, per human) GDP* was \$65,240. (For more data, see [this](https://fred.stlouisfed.org/series/A939RC0A052NBEA).)
